...
class FeedbackWidgetState extends State<FeedbackWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Overlay(
      initialEntries: [
        OverlayEntry(
          builder: (context) => _buildFeedbackOverlayBody(
            context,
            animation: animation,
            feedbackThemeData: FeedbackTheme.of(context),
          ),
        ),
      ],
    );
  ...
  Widget _buildFeedbackOverlayBody(
    BuildContext context, {
    required FeedbackThemeData feedbackThemeData,
